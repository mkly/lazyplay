      ...
      {switch (isIntroVisible) {
        | true =>
          <div>
            ...
            <p>{ReasonReact.string("If you make each section similar, it tends to do a bit better. Also, adding some chords(multiple notes at the same time) along with single notes, also helps.")}</p>
